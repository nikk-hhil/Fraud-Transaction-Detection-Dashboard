...
router.get('/dashboard', async (req, res) => {
  try {
    ...
    // 👇 Add this line to inspect what's being returned
    console.log("DEBUG", { totalTransactions, fraudulentTransactions, totalAmount });
    ...
    console.error("DASHBOARD ROUTE ERROR", error); // log the actual error
